...
type GetTasksId400Response struct {
}

func (response GetTasksId400Response) VisitGetTasksIdResponse(w http.ResponseWriter) error {
	w.WriteHeader(400)
	return nil
}
...
type GetTasksByUserID400Response struct {
}

func (response GetTasksByUserID400Response) VisitGetTasksByUserIDResponse(w http.ResponseWriter) error {
	w.WriteHeader(400)
	return nil
}
